...
public class DameZoneRightAssa : MonoBehaviour
{
    ...
    public string hitAnimationTrigger = "HitRight";
    void Start()
    {
    ...
    public void BeginDameBack()
    {
        listDame.Clear();
        hitAnimationTrigger = "HitBack";
        boxDame.enabled = true;
    }
