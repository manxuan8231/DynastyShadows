...
public class PlayerMove : MonoBehaviour
{
    ...
    [SerializeField] private float gravity = -9.81f; //trong luc
    ...
    public void Jump()
    {
        ...
        // Nếu đang ở trên mặt đất và frame trước không ở trên mặt đất → tiếp đất
        ...
        {
            animator.SetBool("jumpLand", false); // Trong không trung
        }
